...
namespace Post\Advertiser\Stats;
...
class StatsShowModel
{
	public function run()
	{
        ...
        WHERE Offers.id = :offerId AND Offers.author_id = :userId 
...
OFFER_STATS;
		...
		if ($stats) {
			...
			$AJAXJSON['costs'] = round($stats->count * $stats->cost, 2);
